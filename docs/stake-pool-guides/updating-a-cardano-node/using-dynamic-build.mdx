...
:::warning
#### Dynamic binaries from the Armada Alliance repo are no longer actively maintained past 8.2.1. Use the [Static Build guide](./static-build.mdx) for the latest ARM64 node binaries.
:::
...
:::success
#### Current Official Cardano Node Version: [10.7.1](https://github.com/IntersectMBO/cardano-node)
:::
...
:::danger
Dynamic binaries are no longer published past 8.2.1. This download will fail. Switch to the [Static Build guide](./static-build.mdx) instead.
:::

```bash title=">_ Terminal"
wget -O cardano-8_1_2-aarch64-ubuntu_2004.zip https://github.com/armada-alliance/cardano-node-binaries/blob/main/dynamic-binaries/8.2.1/cardano-8_1_2-aarch64-ubuntu_2004.zip?raw=true
```
...
```bash title=">_ Terminal"
cardano-node 8.2.1 - linux-aarch64 - ghc-8.10
...
```bash title=">_ Terminal"
cardano-cli 8.2.1 - linux-aarch64 - ghc-8.10
git rev d2d90b48c5577b4412d5c9c9968b55f8ab4b9767
```
